      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-10 sm:pt-20">
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="grad-multiline font-black leading-[0.95] tracking-tight text-[40px] sm:text-[50px] md:text-[60px] lg:text-[70px] xl:text-[80px]">
            <span className="grad-pink-blue">Compra tu</span><br/>
            <span className="grad-pink italic">boleta</span>
          </h1>
          <p className="mt-4 sm:mt-6 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed text-white/80">
            Asegura tu lugar en la experiencia MR * NØM. Completa el formulario y prepárate para una experiencia inolvidable.
          </p>
        </div>
              ...
              <div className="bg-black/20 rounded-xl p-6 mb-6 text-left">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">Boleta MR * NØM</span>
                  </div>
                  <div className="flex justify-between">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div>
              ...
              >
                ...
                <option value="1" className="bg-black text-white">1 boleta</option>
                <option value="2" className="bg-black text-white">2 boletas</option>
                <option value="3" className="bg-black text-white">3 boletas</option>
                <option value="4" className="bg-black text-white">4 boletas</option>
              </select>
            </div>
            ...
            <div className="pt-4">
              ...
              >
                {isLoading ? 'PROCESANDO...' : 'COMPRAR BOLETA'}
              </button>
            </div>
